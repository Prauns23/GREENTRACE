...
<body>
    <div class="report-container">
        ...
        <div class="report-content">
            <form action="" id="reportForm">
                ...
                <div class="form-group">
                    ...
                    <textarea name="" id="report-description" placeholder="Describe the issue in detail..."
                        rows="4"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="location-input-group">
                        <input type="text" placeholder="e.g., Ibayo, Balanga City, Bataan or Coordinates"
                            class="location-search">
                        <button type="button" class="gps-btn">
                            <i class="fas fa-location-dot"></i>
                        </button>
                    </div>
                    <!-- Map (hidden by defaut) -->
        ...
        <div class="location-hint" id="locationHint">
            ...
            <span>Enter a descriptive location or use GPS for coordinaes</span>
        </div>
        ...
        <div class="button-group">
            ...
            <button type="button" class="cancel-btn"
                onclick="parent.hideFloating && parent.hideFloating()">Cancel</button>
        </div>
        </form>
    </div>
