...
$isDisabled = ($existingStatus === 'pending' || $existingStatus === 'approved');
...
<body>
        ...
        <div class="modal-body">
            <?php if ($isDisabled): ?>
                <div class="alert alert-warning" style="background: #fff3cd; color: #856404; padding: 12px; border-radius: 8px; margin-bottom: 20px;">
                    <?php if ($existingStatus === 'pending'): ?>
                        You have already submitted a request for this activity. Please wait for admin review.
                    <?php elseif ($existingStatus === 'approved'): ?>
                        You are already approved for this activity.
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            ...
            <form id="applicationForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_of_birth" required <?php echo $isDisabled ? 'disabled' : ''; ?>>
                </div>

                <div class="form-group">
                    <label>Birth Sex</label>
                    <select name="gender" <?php echo $isDisabled ? 'disabled' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="upload-area" id="uploadArea" style="<?php echo $isDisabled ? 'opacity:0.6; pointer-events:none;' : ''; ?>">
                        <input type="file" id="fileUpload" name="verification_files[]" multiple accept="image/*,application/pdf" hidden <?php echo $isDisabled ? 'disabled' : ''; ?>>
                ...
                <div class="checkbox-group">
                    <label>
                        <input type="checkbox" name="understand" required <?php echo $isDisabled ? 'disabled' : ''; ?>>
                        <span>I understand the importance of reforestation and will follow planting guidelines.</span>
                    </label>
                    <label>
                        <input type="checkbox" name="agree" required <?php echo $isDisabled ? 'disabled' : ''; ?>>
    ...
    <script src="volunteer.js?v2"></script>
</body>
